 ...
 * @param {Partial<LoaderPrefetchConfig>} [config] - Optional configuration. Defaults to { enabled: true }
 * @returns {Provider[]} Provider array to add to application providers
 * @example
 * ```typescript
