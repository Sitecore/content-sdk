...
- `<sc-placeholder-metadata>` now renders with `display: contents`, so components inside a placeholder lay out correctly in flex and grid containers in editing mode. ([0356f0f](https://github.com/sitecore/content-sdk/commit/0356f0f053fb300f84eda3078cc81874eba59bc8))
