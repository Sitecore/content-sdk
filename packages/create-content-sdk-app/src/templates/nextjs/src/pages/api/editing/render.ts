import { EditingRenderProxy } from '@sitecore-content-sdk/nextjs/editing';
...
// Wire up the EditingRenderProxy handler
const handler = new EditingRenderProxy().getHandler();
