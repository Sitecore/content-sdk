...
`page.tsx` and `generateMetadata` share `getSitecorePageForRequest` so preview / Design Library omit tokens (literals preserved) and published paths reuse one request-scoped finalized page.
