...
# Field usage (Text, Image, Link) (App Router + Cache Components)
...
- Use SDK field components
- Validate fields before render

## Stop

- Stop if rendering unsanitized external HTML
