...
export interface ProxyConfig {
    ...
    onError?: (error: Error, response: IncomingMessage) => null | {
        statusCode?: number;
        content?: string;
    } | Promise<{
        statusCode?: number;
    ...
    createViewBag?: (request: IncomingMessage, response: ServerResponse, proxyResponse: IncomingMessage, layoutServiceData: LayoutServiceData) => Promise<{
        [key: string]: unknown;
    }> | {
        [key: string]: unknown;
    };
