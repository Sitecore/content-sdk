 ...
 * @public
 */
export declare function resolveFieldEditingState(field: (FieldMetadata & Partial<Field<GenericFieldValue>>) | null | undefined, editable: boolean): FieldEditingState;
