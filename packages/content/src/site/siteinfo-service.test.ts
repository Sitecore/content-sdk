...
import { debugModule } from '@sitecore-content-sdk/core';
...
describe('SiteInfoService', () => {
  ...
  before(() => {
    debugNamespaces = debugModule.disable();
    debugModule.enable(debug.multisite.namespace);
  });
  ...
  after(() => {
    debugModule.enable(debugNamespaces);
  });
