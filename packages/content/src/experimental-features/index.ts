 ...
 *
 * Source of truth for the catalog is `src/experimental.json` in this package.
 ...
 *
 * Framework packages (Next.js, Angular) consume this shared module for HTTP adapters.
 */
export type {
