...
import { RichTextOptimized } from './RichTextOptimized';
import { RichTextField } from './RichText';

describe('<RichTextOptimized />', () => {
  it('should render nothing with missing field', () => {
    const field: RichTextField = null;
    const rendered = render(<RichTextOptimized field={field} />).container.querySelectorAll('div');
  ...
  it('should render value with editing explicitly disabled', () => {
    ...
    const rendered = render(
      <RichTextOptimized field={field} editable={false} />
  ...
  it('should render tag with a tag provided', () => {
    ...
    const rendered = render(
      <RichTextOptimized field={field} tag="p" />
  ...
  it('should render other attributes with other props provided', () => {
    ...
    const rendered = render(
      <RichTextOptimized field={field} tag="h1" className="cssClass" id="lorem" />
  ...
  describe('edit mode', () => {
    ...
    it('should render field metadata component when metadata property is present', () => {
      ...
      const rendered = render(<RichTextOptimized field={field} />);
    ...
    it('should render custom empty field component when provided, when field value is empty in edit mode metadata', () => {
      ...
      const rendered = render(
        <RichTextOptimized field={field} emptyFieldEditingComponent={EmptyFieldEditingComponent} />
      );
    ...
    it('should render nothing when field value is empty, when editing is explicitly disabled in edit mode metadata', () => {
      ...
      const rendered = render(<RichTextOptimized field={field} editable={false} />);
