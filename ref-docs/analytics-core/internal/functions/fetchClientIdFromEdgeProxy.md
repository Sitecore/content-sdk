...
Defined in: [analytics-core/src/client-id/fetch-client-id-from-edge-proxy.ts:16](https://github.com/Sitecore/content-sdk/blob/4d29d61d70888b209012562aa8b51d864557cd36/packages/analytics-core/src/client-id/fetch-client-id-from-edge-proxy.ts#L16)
