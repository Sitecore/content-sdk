...
[@sitecore-content-sdk/nextjs](../../README.md) / [index](../README.md) / BYOCClientWrapper

# Variable: BYOCClientWrapper()

> `const` **BYOCClientWrapper**: (`props`) => `JSX.Element`

Defined in: react/types/components/FEaaS/BYOCWrapper.d.ts:28
