...
[@sitecore-content-sdk/core](../../README.md) / [tools](../README.md) / areURLSearchParamsEqual

# Function: areURLSearchParamsEqual()

> **areURLSearchParamsEqual**(`params1`, `params2`): `boolean`

Defined in: [packages/core/src/tools/utils.ts:181](https://github.com/Sitecore/content-sdk/blob/935d69d056b753a906f23541fe4b788acdc743ae/packages/core/src/tools/utils.ts#L181)
