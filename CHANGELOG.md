...
* `[rect]` `[nextjs]` `[DesignLibrary]` Refresh path in updateComponentAction and move it and its dependents to nextjs package. ([#400](https://github.com/Sitecore/content-sdk/pull/400))
