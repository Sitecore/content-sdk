...
* `[core]` `[nextjs]` Restore proper local connection fallback ([#178](https://github.com/Sitecore/content-sdk/pull/178))* `[core]` `[nextjs]` Restore proper local connection fallback ([#180](https://github.com/Sitecore/content-sdk/pull/180))
