...
* `[nextjs]` `[create-content-sdk-app]` Upgrade to Next.js 16, add Cache Components feature and Turbopack File System Caching ([#334](https://github.com/Sitecore/content-sdk/pull/334))([#401](https://github.com/Sitecore/content-sdk/pull/401))
  - Next.js App Router template ships with Cache Components **off** by default. To opt-in for this feature set `cacheComponents: true` add Suspense or `"use cache"` where required by Next.js.
...
* `[react]` `[nextjs]` `[template/nextjs-app-router]` Fix not-found page forcing `[[...path]]` route to dynamic rendering; use cached page params to preserve SSG ([#399](https://github.com/Sitecore/content-sdk/pull/399))
