...
* `[rect]` `[nextjs]` `[DesignLibrary]` In variant generation mode prevent additional server re-render by passing the rendering along with variant generation data to previewComponentAction ([#403](https://github.com/Sitecore/content-sdk/pull/403))
